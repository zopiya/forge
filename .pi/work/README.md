...
These files are committed, on purpose — see `.pi/design.md` §3.6. When a feature branch merges, its `.pi/work/<slug>/` becomes part of the historical record for that change.
