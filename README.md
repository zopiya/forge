...
- `.pi/prompts/` — `/commit`, `/changelog`, `/readme`, `/status`, `/retro`: prompt templates for the repetitive stuff. `/retro` mines an exported session log for real friction points and turns them into doc fixes — see `docs/design.md` §8.
